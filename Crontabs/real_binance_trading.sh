...
python3 /home/pi/CryptoCurrency/Binance/bin_actual_investments.py -d /media/pi/HaberServer/Crypto_Share/Binance/ -i BTC ETH LTC -r 1
...
# Creation of graphs
# Balances
python3 /home/pi/CryptoCurrency/Utility/graph_creation.py -c /media/pi/HaberServer/Crypto_Share/Binance/Actual/Balances/BTC_Balance.csv -v cash -t /media/pi/HaberServer/Crypto_Share/Binance/Databases/
python3 /home/pi/CryptoCurrency/Utility/graph_creation.py -c /media/pi/HaberServer/Crypto_Share/Binance/Actual/Balances/ETH_Balance.csv -v cash -t /media/pi/HaberServer/Crypto_Share/Binance/Databases/
python3 /home/pi/CryptoCurrency/Utility/graph_creation.py -c /media/pi/HaberServer/Crypto_Share/Binance/Actual/Balances/LTC_Balance.csv -v cash -t /media/pi/HaberServer/Crypto_Share/Binance/Databases/
# Prices
