...
class API_Client:
    ...
    def GetAPIKeys(self):
        ...
        public_file = dak.GetAPIKeyFile("/API/api.key", public_file_encrypted, "/API/API_Binance_public_key")
        secret_file = dak.GetAPIKeyFile("/API/api.key", secret_file_encrypted, "/API/API_Binance_secret_key")
